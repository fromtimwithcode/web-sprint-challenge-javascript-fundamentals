...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPopArray = array.filter(item => item.population < 5);
  ...
  */
  ...
  function USApop(array){
    const reduced = array.reduce((acc, val) => {
...
console.log('Callback (add): ', consume(1, 3, add));
...
function multiply(a, b){
  ...
  console.log('Callback (multiply): ', consume(2, 3, multiply));
...
function greeting(first, last){
  ...
  console.log('Callback (greeting): ', consume('Tim', 'Marchant', greeting));
...
// ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️
console.log('Prototypes 1: ', cuboid.volume()); // 100
console.log('Prototypes 2: ', cuboid.surfaceArea()); // 130
...
//🦄🦄🦄 Test your volume and surfaceArea methods by uncommenting the logs below: 🦄🦄🦄
console.log('Classes 1: ', cuboidTwo.volume()); // 100
console.log('Classes 2: ', cuboidTwo.surfaceArea()); // 130
